CREATE   PROCEDURE Sales.LoadDataFromStaging (@OrderYear INT)
 AS
 BEGIN
 	-- Load data into the Customer dimension table from view of lakehouse
     ...
     -- Load data into the Item dimension table from view of lakehouse
     ...
     -- Load data into the Sales fact table from view of lakehouse
