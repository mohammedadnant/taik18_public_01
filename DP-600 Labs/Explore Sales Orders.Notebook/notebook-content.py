...
# META       "default_lakehouse_name": "LH_DP600_Spark_01",
...
# df now is a Spark DataFrame containing CSV data from "Files/orders/2019.csv" for single mention exact file name, * for all inside that folder.
display(df)
...
# Create a new table
df.write.format("delta").saveAsTable("salesorders4")

# Get the table description
spark.sql("DESCRIBE EXTENDED salesorders4").show(truncate=False)
...
df = spark.sql("SELECT * FROM LH_DP600_Spark_01.salesorders2 LIMIT 1000")
display(df)
